...
export const Outcomes = () => {
  ...
  return (
    <section className="w-full  outcomes-tiktok flex flex-col md:gap-y-4 py-8  ">
      <div className="max-w-[1660px] mx-auto w-full  flex flex-col px-6 sm:px-12 md:px-20 py-10 md:py-16 lg:py-20 gap-y-12 bg-background">
        <motion.div
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <p className="text-[10px] md:text-base lg:text-xl text-center text-darkGray">
            Within the first 90 days of working with us, clients have achieved:
          </p>
        </motion.div>
        <motion.div 
