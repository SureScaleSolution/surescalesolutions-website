...
const HeroPart1 = () => {
  return (
    <section className="">
      <div className="max-w-[1660px] flex items-center justify-between mx-auto w-full px-4 sm:px-8 md:px-12 lg:px-16  py-10 sm:py-14 md:py-12 ">
        {/* Text part */}
        <motion.div
          variants={fadeLeft}
          initial="hidden"
        ...
        >
          <h1 className="text-3xl md:text-4xl lg:text-[50px] font-semibold mb-4 text-secondary ">
            MarketPlace Account Reinstatement Services{" "}
          </h1>
          <p className="text-sm md:text-lg font-light mb-6">
            Suspension is not the last stop it&apos;s only temporary. <br />
            At SureScaleSolution, we specialize in reinstating accounts on
            Amazon, Walmart, TikTok Shop, eBay, and Shopify. <br />
            Our experts know how to craft proper submissions for policy or
            violation cases.We have handled multiple case studies where
            suspended accounts were successfully reactivated. <br />
          </p>
        ...
        >
          <div className="pt-8 w-[400px] mx-auto ">
            <Image
              src="/account-reinstatement/hero/hero.svg"
