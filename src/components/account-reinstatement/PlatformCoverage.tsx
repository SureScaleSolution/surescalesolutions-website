...
export const PlatformCoverage = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-white via-background/30 to-background  ">
      <div className="max-w-[1660px] mx-auto w-full  flex flex-col px-6 sm:px-12 md:px-20 py-10 md:py-16 gap-y-12">
        ...
        >
          <Heading2 first="Platform Coverage" />
          <p className="text-[10px] md:text-base lg:text-xl text-center text-darkGray">
            At <span className="font-bold text-primary">SureScaleSolution,</span> we handle account reinstatements
          ...
          {services.map((item, index) => (
            ...
            >
              <div className="w-[75px]">
                <Image
                  src={`/account-reinstatement/platform-coverage/${item.icon}.svg`}
                  alt={`Icon ${item.icon}`}
